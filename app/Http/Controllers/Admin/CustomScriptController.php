...
class CustomScriptController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('custom-script.index') // pastikan konsisten dengan store()
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('custom-script.index')->with('success', 'Custom script deleted successfully.');
    }
