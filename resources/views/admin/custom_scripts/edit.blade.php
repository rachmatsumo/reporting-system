...
@section('content')
<div class="container">
    <x-page-header route-prefix="custom-scripts" mode="edit" />
    <form method="POST" action="{{ route('custom-scripts.update', $script->id) }}">
        @csrf 
        @method('PUT')
        ...
        <x-form-buttons route-prefix="custom-scripts" mode="edit" />
    </form>
</div>  
