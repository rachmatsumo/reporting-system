            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h5 class="mb-0">Add New Report Design</h5>
                    </div>
                    <div class="card-body">
                        <form id="reportDesignForm" method="POST" action="{{ route('report-design.store') }}">
                            @csrf 
