            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h5 class="mb-0">Edit Report Design: {{ $reportDesign->name }}</h5>
                    </div>
                    <div class="card-body">
                        <form id="reportDesignForm" method="POST" action="{{ route('report-design.update', $reportDesign) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <ul class="nav nav-tabs" id="reportTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="main-fields-tab" data-bs-toggle="tab" 
                                        ...
                                        <i class="fas fa-file-alt me-2"></i>Main Fields ({{ $reportDesign->fields->count() }})
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="sub-reports-tab" data-bs-toggle="tab" 
                                            data-bs-target="#sub-reports" type="button" role="tab">
                                        <i class="fas fa-layer-group me-2"></i>Sub Reports ({{ $reportDesign->subDesigns->count() }})
                                    </button>
                                </li>
                            </ul>
                                    ...
                                    <div class="mt-4">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <button type="button" class="btn btn-success btn-sm" onclick="addSubReport()">
                                                <i class="fas fa-plus"></i> Tambah Sub Report
                                            </button>
                                        </div>
                            ...
                            <div class="text-end mt-5">
                                <a href="{{ route('report-design.index') }}" class="btn btn-secondary">Batal</a>
...
function updateTabCounts() {
    ...
    document.getElementById('main-fields-tab').innerHTML = `<i class="fas fa-file-alt me-2"></i>Main Fields (${mainFieldsCount})`;
    document.getElementById('sub-reports-tab').innerHTML = `<i class="fas fa-layer-group me-2"></i>Sub Reports (${subReportsCount})`;
}
...
<!-- Include SortableJS if not already included -->
