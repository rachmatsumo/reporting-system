...
<div class="container">
    {{-- <h6>Edit Role</h6> --}}
    <x-page-header route-prefix="roles" mode="edit" />
    ...
    <form action="{{ route('roles.update', $role) }}" method="POST">
        ...
        <div class="row mb-4">
            ...
            @endphp
            <div class="col-12 col-md-4 permission-card d-flex mb-3" style="animation-delay: {{ $loop->index * 0.1 }}s">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            @foreach($lists as $list)
                                ...
                                <div class="form-check form-check-inline">
                                    <input type="checkbox" name="permissions[]" value="{{ $list->name }}" class="form-check-input" 
                                        {{ $role->permissions->contains('name', $list->name) ? 'checked' : '' }} id="{{ $list->name }}">
        ...
        <x-form-buttons route-prefix="roles" mode="edit" /> 
    </form>
</div>
@endsection
