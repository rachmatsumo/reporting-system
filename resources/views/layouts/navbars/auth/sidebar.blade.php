    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ Request::is('reports*') ? 'active' : '' }}" href="{{ url('reports') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fa fa-folder-open ps-2 pe-2 text-center text-dark {{ (Request::is('reports*') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ Request::is('custom-script*')  ? 'active' : '' }}" href="{{ url('custom-script') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-code fa-palette ps-2 pe-2 text-center text-dark {{ (Request::is('custom-script*') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Custom Script</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link {{ Request::is('report-design*')  ? 'active' : '' }}" href="{{ url('report-design') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-palette ps-2 pe-2 text-center text-dark {{ (Request::is('report-design*') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
          <span class="nav-link-text ms-1">Report Design</span>
        </a>
      </li>
      ...
      {{-- <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">User Section</h6>
      </li>
